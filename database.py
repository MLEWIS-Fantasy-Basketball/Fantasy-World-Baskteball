...
try: 
    conn = psycopg2.connect("dbname = fantasy_basketball user = arjunthakar")

except:
    print("Could not open connection.")

df = pd.read_csv('/Users/arjunthakar/Database/Fantasy-World-Baskteball/players_stats_by_season_full_details.csv', header = 0)
